                    ...
                    @foreach($msgTraces as $traceIndex => $trace)
                        @php
                            ...
                            if (in_array($trace->node_name, ['Tier2GenerativeAI', 'Tier2GenerativeAI_Retry', 'OutOfContextQuery'])) {
                                ...
                                $aiTier = 'Tier 0 AI';
                            } elseif (in_array($trace->node_name, ['CategoryPHPMultiMatch', 'ProductPHPMultiMatch', 'ProductMatchPHP', 'ColumnFilterSelected', 'CategorySelected', 'ProductSelected', 'PHPProductGroupMatch', 'PGMCategoryAutoSelect', 'PGMCategoryMultiMatch', 'PGMCategoryResolve', 'QueueNextCategory'])) {
                                $aiTier = 'Tier 0 Logic';
                            }
                        @endphp
