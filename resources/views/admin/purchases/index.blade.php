    ...
    <script>
        ...
        function buildPurchaseRow(p, customFields) {
            ...
            if (canWrite) {
                ...
                if (canDelete) {
                    html += '<button type="button" onclick="ajaxDelete('{{ url(')" style="width:32px;height:32px;border-radius:8px;background:#fef2f2;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#ef4444;transition:all 0.15s" title="Delete" onmouseover="this.style.background=\'#fee2e2\'" onmouseout="this.style.background=\'#fef2f2\'"><i data-lucide="trash-2" style="width:16px;height:16px"></i></button>';
                }
            }
            html += '</div></td></tr>';
            return html;
