    ...
    <style>
        * {
        ...
        .print-btn {
            ...
            right: 16px;
            padding: 10px 20px;
            background: linear-gradient(135deg, #522081, #3b1361);
            color: white;
            border: none;
            border-radius: 6px;
            cursor: pointer;
        ...
        .print-btn:hover {
            background: linear-gradient(135deg, #3b1361, #260b40);
        }
    ...
    <div class="invoice-wrapper">
        ...
        <div class="header-row">
            <div class="header-left">
                ...
                @else
                    <div style="width:90px;height:75px;border:2px solid #522081;border-radius:8px;display:flex;align-items:center;justify-content:center;text-align:center;font-size:10px;font-weight:700;color:#522081;line-height:1.2;padding:4px;">
        ...
        <div class="bill-info-row">
            ...
            <div class="info-col">
                ...
                @endif
                <div class="info-line"><strong>Quotation No. : {{ $quote->quote_no }}</strong></div>
                <div class="info-line"><strong>Date : {{ $invoiceDate }}</strong></div>
                @if($quote->valid_till)
                <div class="info-line"><strong>Valid Till : {{ $quote->valid_till->format('d-m-Y') }}</strong></div>
                @endif
            </div>
        </div>
        ...
        {{-- Amount In Words --}}
        <div class="words-bar">
            <div class="words-header">Quotation Amount In Words</div>
