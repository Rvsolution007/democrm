    ...
    (function() {
        ...
        function saveOrder() {
            ...
            getRows().forEach(function(r, i) {
                ...
                var idxTd = r.querySelector('td:nth-child(2)');
                if (idxTd) {
            ...
            .then(function(data) {
                if (data.success) {
                    showAlert('success', 'Chatflow order updated successfully');
                    
                    // After a short delay, visually reload to reorder the flow preview boxes on top
