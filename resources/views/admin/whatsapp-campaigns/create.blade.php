...
@section('title', 'Start New Campaign')
...
@section('content')
    <div class="container-fluid" style="padding: 1.5rem;">
        ...
        <div class="page-header-modern">
            <div>
                <h2 class="page-title-modern">New Broadcast Campaign</h2>
                <p class="text-muted mt-1 mb-0" style="font-size: 0.9rem;">Deploy rich interactive messages to your targeted
                    leads</p>
            </div>
            <div class="header-actions">
                <a href="{{ route('admin.whatsapp-campaigns.index') }}" class="btn-history-modern">
                    <i data-lucide="history" style="width: 16px; height: 16px;"></i> Historical Manifest
                </a>
            </div>
        </div>
            ...
            <div class="col-lg-5">
                <div class="modern-card">
                    <div class="modern-card-header">
                        ...
                        <h6>Configure Campaign Details</h6>
                    </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p style="color: #c2410c; font-size: 0.85rem; margin: 0; line-height: 1.5;">Campaign
                                        ...
                                        ban-flags by the Meta ecosystem. Safe to navigate away post-deployment.
                                    </p>
                                </div>
                            </div>
                        </div>
